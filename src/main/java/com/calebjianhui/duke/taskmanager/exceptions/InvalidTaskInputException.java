...
public class InvalidTaskInputException extends Exception {
    ...
    public static final String REPLY_FIXED_DURATION_NO_DURATION = "Please include the duration for your fixed duration task.";
    public static final String REPLY_FIXED_DURATION_INVALID_LENGTH = "Please include the description and duration of your task.";

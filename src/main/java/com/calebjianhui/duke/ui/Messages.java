...
public class Messages {
    ...
    public static final String REPLY_CONFIRM_MARK_TASK = "Nice! I've marked this task as done:";
    public static final String REPLY_CONFIRM_UNMARK_TASK = "Ok, I've marked this task as not done yet:";

...
public class DukeConstants {
    ...
    public static final Pattern CONTAINS_MARK = Pattern.compile("^mark.*$");
    public static final Pattern UNMARK = Pattern.compile("^unmark\\s[0-9]+$");
    public static final Pattern CONTAINS_UNMARK = Pattern.compile("^unmark.*$");
    public static final Pattern DELETE = Pattern.compile("^delete\\s[0-9]+$");
    public static final Pattern CONTAINS_DELETE = Pattern.compile("^delete.*");

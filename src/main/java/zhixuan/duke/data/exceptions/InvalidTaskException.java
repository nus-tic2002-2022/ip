...
public class InvalidTaskException extends Exception {
    ...
    public static final String REPLY_INVALID_TASK = "Please choose a task with a due date (Event or Deadline tasks).";
    public static final String REPLY_INVALID_DATETIME_ENUM = "Please choose a valid date or time (year, month, day, hour or minute).";
